...
let favoriteFoods = ['sushi', 'pho', 'steak'];
...
console.log('Last animal using array length is', lastAnimal);
...
let removedFood = favoriteFoods.pop('roast beef');
...
favoriteFoods.unshift('pot roast');
